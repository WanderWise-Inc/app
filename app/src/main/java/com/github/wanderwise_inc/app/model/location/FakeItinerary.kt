          ...
          locations =
              listOf(
                  ...
                  Location(
                      ...
                      long = 139.7732,
                      title = "Ueno Park",
                      address = "5 Chome-20 Uenokoen, Taito City, Tokyo 110-0007, Japan",
                      googleRating = 4.7f),
                  Location(
                      lat = 35.6852,
                      long = 139.7103,
          ...
          locations =
              listOf(
                  Location(
                      ...
                      address = "425 Jefferson Street, San Francisco",
                      googleRating = 4.5f),
                  Location(
                      lat = 37.7757292,
                      long = -122.4119508,
                      title = "Mike's Bikes of San Francisco",
                      address = "1233 Howard Street, San Francisco",
                      googleRating = 4.0f),
                  Location(
                      lat = 37.8060487,
                      long = -122.4206076,
                      title = "Blazing Saddles Bike Rentals & Tours",
                      address = "2715 Hyde Street, San Francisco",
                      googleRating = 4.1f),
                  Location(
                      lat = 37.7809098,
                      long = -122.4117142,
                      title = "Huckleberry Bicycles",
                      address = "1073 Market Street, San Francisco",
                      googleRating = 4.7f),
                  Location(
                      lat = 37.7665228,
                      long = -122.4532875,
                      title = "American Cyclery",
                      address = "510 Frederick Street, San Francisco",
                      googleRating = 4.5f)),
