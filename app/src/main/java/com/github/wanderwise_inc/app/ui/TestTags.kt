...
object TestTags {
  ...
  const val ITINERARY_CREATION_PRICE_ESTIMATION = "Itinerary Creation Price Estimation"
  const val ITINERARY_CREATION_TIME_ESTIMATION = "Itinerary Creation Time Estimation"
  const val ITINERARY_CREATION_TAGS = "Itinerary Creation Tags"
