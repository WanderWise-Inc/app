 ...
 *
 * This class is used to perform long-running operations in the background. It is a component that
 * runs in the background to perform long-running operations without providing a user interface.
...
class LocationService : Service() {
   ...
   *
   * This companion object contains constants that represent the actions that can be performed by
   * the `LocationService`.
   */
  companion object {
