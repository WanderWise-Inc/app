 ...
 *
 * This class is responsible for creating and providing instances of various classes used throughout the application.
 * It uses the lazy initialization pattern to ensure that instances are only created when they are needed.
 *
