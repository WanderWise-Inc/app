...
/**
 * `GoogleSignInLauncher` is a class that implements the `SignInLauncher` interface to handle Google sign-in.
 *
 * This class is responsible for initiating the sign-in process using Google as the identity provider.
 */
