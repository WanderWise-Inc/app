...
class ItineraryTest {
  ...
  @Test fun scoreFromPreferences() {
    ...
    assertEquals(10.0 * (sfObject.getLikes() + 1), sfObject.scoreFromPreferences(sfPreferences), 0.000001)
    assertEquals(20.0 * (tkObject.getLikes() + 1), tkObject.scoreFromPreferences(tkPreferences), 0.000001)
    assertEquals(0.0 * (swObject.getLikes() + 1), swObject.scoreFromPreferences(swPreferences), 0.000001)
  }
  ...
  @Test fun `getLocations should return the correct locations of an itinerary`() {
  ...
  @Test fun `get likes should return the correct number of like`() {
  ...
  @Test fun `incrementLike should increment the number of likes`() {
