...
class LikedNavigationTest {    
    ...
    fun verify_StartDestinationIsLikedAdventureScreen() {
        composeTestRule
            .onNodeWithTag("Liked Adventure screen")
            .assertIsDisplayed()
    ...
    fun performClick_OnShoppingButton_NavigatesToLikedShoppingScreen() {
        composeTestRule
            .onNodeWithTag(Route.LIKED + "/" + Tags.SHOPPING)
            .performClick()

        composeTestRule
            .onNodeWithTag("Liked Shopping screen")
            .assertIsDisplayed()
    ...
    fun performClick_OnSightseeingButton_NavigatesToLikedSightseeingScreen() {
        composeTestRule
            .onNodeWithTag(Route.LIKED + "/" + Tags.SIGHT_SEEING)
            .performClick()

        composeTestRule
            .onNodeWithTag("Liked Sight-seeing screen")
            .assertIsDisplayed()
    ...
    fun performClick_OnDrinksButton_NavigatesToLikedDrinksScreen() {
        composeTestRule
            .onNodeWithTag(Route.LIKED + "/" + Tags.DRINKS)
            .performClick()

        composeTestRule
            .onNodeWithTag("Liked Drinks screen")
            .assertIsDisplayed()
